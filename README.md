...
<table style="width: 100%; text-align: center;">
  <tr>
    <td style="width: 100%;">Meses</td>
    <td style="width: 100%;">Tipo de Gato</td>
    <td style="width: 100%;">Temperatura</td>
    <td style="width: 100%;">Peso</td>
    <td style="width: 100%;">Desparasitación</td>
    <td style="width: 100%;">Salida</td>
  </tr>
  <tr>
    <td colspan="1" style="width: 33%; padding-top: 0px;">Adulto</td>
    <td colspan="1" style="width: 33%; padding-top: 50px;">Doméstico</td>
    ...
    <td colspan="1" style="width: 33%; padding-top: 50px;">Tu Gato tiene obesidad y necesita desparasitación se necesita llevar a un hospital de animales</td>
  </tr>
 <tr>
    ...
    <td colspan="1" style="width: 33%; padding-top: 50px;">2 a 3 meses</td>
    <td colspan="1" style="width: 33%; padding-top: 50px;">Tu gato tiene obesidad para ser un cachorro, lo normal sería 1 a 2 kilos, tambien necesitas llevarlo a un hospital de animales por la alta temperatura</td>
  </tr>
   <tr>
    <td colspan="1" style="width: 33%; padding-top: 0px;">Adulto</td>
    <td colspan="1" style="width: 33%; padding-top: 50px;">Doméstico</td>
   ...
   <tr>
    <td colspan="1" style="width: 33%; padding-top: 0px;">Cachorro</td>
    <td colspan="1" style="width: 33%; padding-top: 50px;">Maine Coon</td>
    <td colspan="1" style="width: 33%; padding-top: 50px;">Alta</td>
    <td colspan="1" style="width: 33%; padding-top: 50px;">4 a 5 kilos</td>
    <td colspan="1" style="width: 33%; padding-top: 50px;">1 a 2 meses</td>
    <td colspan="1" style="width: 33%; padding-top: 50px;">Tu gato tiene obesidad para ser un cachorro, lo normal sería 1 a 2 kilos, tambien necesitas llevarlo a un hospital de animales por la alta temperatura</td>
   ...
   <tr>
    ...
    <td colspan="1" style="width: 33%; padding-top: 50px;">1 a 2 meses</td>
    <td colspan="1" style="width: 33%; padding-top: 50px;">Tu gato tiene desnutrición lo normal seria 3 a 4 kilos en adultos, se necesita llevarlo al hospital de animale por la alta temperatura</td>
  </tr>
   <tr>
    <td colspan="1" style="width: 33%; padding-top: 0px;">Adulto</td>
    <td colspan="1" style="width: 33%; padding-top: 50px;">Maine Coon</td>
   ...
   <tr>
    ...
    <td colspan="1" style="width: 33%; padding-top: 50px;">2 a 3 meses</td>
    <td colspan="1" style="width: 33%; padding-top: 50px;">Tu gato tiene muy baja temperatura se necesita mantenerlo caliente hasta que cambie a tibio  y peso se necesita  alimentar un poco más para estar al peso ideal</td>
  </tr>
   <tr>
    <td colspan="1" style="width: 33%; padding-top: 0px;">Adulto</td>
    <td colspan="1" style="width: 33%; padding-top: 50px;">Siames</td>
   ...
   <tr>
    ...
    <td colspan="1" style="width: 33%; padding-top: 50px;">1 a 2 meses</td>
    <td colspan="1" style="width: 33%; padding-top: 50px;">Tu gato está saludable sigue asi</td>
  </tr>
   <tr>
    <td colspan="1" style="width: 33%; padding-top: 0px;">Adulto</td>
    <td colspan="1" style="width: 33%; padding-top: 50px;">Bengai</td>
